...
TEST(AT24C_Test, init){
    ...
    i2c.setReadingBuffor({
        {addr, 0x0000, {0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff}},
        {addr, 0x0000, {0xac, 0x53, 0x35, 0xba, 0xc8, 0xc2, 0xaa, 0x26, 0xff, 0x00}},
        {addr, 0x0000, {0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff}},
    });
...
TEST(AT24C_Test, initSize0){
    ...
    Drivers::Memory memory(&i2c, &gpio, addr, OutputList::MemoryWriteProtect, MemoryTestSpcae::delay);
    i2c.setReadingBuffor({
        {addr, 0x0000, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
        {addr, 0x0000, {0xac, 0x53, 0x35, 0xba, 0xc8, 0xc2, 0xaa, 0x26, 0xff, 0x00}},
        {addr, 0x0000, {0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff}},
    });
